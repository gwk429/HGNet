...
dataset = '3DMatch'
experiment_id = f"PGNet_{dataset}_{time.strftime('gwk1')}"
#print(experiment_id)
...
net_arg.add_argument('--k', type=int, default=20, help='size of local neighborhood')
...
if dataset == '3DMatch':
    data_arg.add_argument('--root', type=str, default='F:/gwk/datasets/3DMatch')
    data_arg.add_argument('--descriptor', type=str, default='fpfh', choices=['d3feat', 'fpfh', 'fcgf'])
    data_arg.add_argument('--inlier_threshold', type=float, default=0.10)
    net_arg.add_argument('--sigma_d', type=float, default=0.10)
    data_arg.add_argument('--downsample', type=float, default=0.05)
    ...
    data_arg.add_argument('--root', type=str, default='/media/lixiaohan/下载/huohu/PointDSC-master/data/KITTI')
    data_arg.add_argument('--descriptor', type=str, default='fpfh', choices=['fcgf', 'fpfh'])
    data_arg.add_argument('--inlier_threshold', type=float, default=0.6)
    net_arg.add_argument('--sigma_d', type=float, default=0.6)
