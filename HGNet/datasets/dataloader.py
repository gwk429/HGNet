...
def collate_fn(list_data):
    ...
    return batched_corr_pos, batched_src_keypts, batched_tgt_keypts, batched_src_normal, batched_tgt_normal, batched_gt_trans, batched_gt_labels  #, m1 #, batched_src_features, batched_tgt_features
