...
from models.Space_Normal import space_normal, compute_angle
...
class Trainer(object):
    ...
    def train_epoch(self, epoch):
        ...
        for iter in range(num_iter):
            data_timer.tic()
            #(corr_pos, src_keypts, tgt_keypts, gt_trans, gt_labels, src_features,tgt_features) = trainer_loader_iter.next()
    ...
    def evaluate(self, epoch):
        ...
        for iter in range(num_iter):
            data_timer.tic()
            #(corr_pos, src_keypts, tgt_keypts, gt_trans, gt_labels, src_features, tgt_features) = val_loader_iter.next()
