...
if __name__ == '__main__':
    ...
    shutil.copy2(os.path.join('.', 'models/HGNet.py'), os.path.join(config.snapshot_dir, 'model.py'))  # for the model setting.
    ...
    #print('generator parameters:', sum(param.numel() for param in config.model.parameters()))
    # create optimizer
